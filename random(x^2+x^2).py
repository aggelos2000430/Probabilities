...
for i in range(10000):
    y = math.pow(random.uniform(0, 1), 2) + math.pow(random.uniform(0, 1), 2) + math.pow(random.uniform(0, 1), 2) + math.pow(random.uniform(0, 1), 2) + math.pow(random.uniform(0, 1), 2)
    for range in freq.keys():
        if range[0] <= y <= range[1]:
            freq[range] += 1

with open('Random(y = x^2 + x^2 + x^2 + x^2 + x^2).csv', 'w', newline='') as file:
...
freq = {}
with open('Random(y = x^2 + x^2 + x^2 + x^2 + x^2).csv', newline='') as file:
...
plt.title('Random(y = x^2 + x^2 + x^2 + x^2 + x^2)')
plt.show()